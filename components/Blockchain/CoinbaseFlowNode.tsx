...
export interface CoinbaseFlowNodeData
  extends Omit<GenericBlockType, "data" | "id"> {
        ...
        title={
          ...
          >
            <Tooltip
              title={t(
                "TooltipBlockNumber",
                "This is the unique identifier for the block in the chain."
              )}
            >
              <Typography.Title
                level={5}
            ...
            <Tooltip
              title={
                data.isValid
                  ? t("TooltipValidBlock", "This block is valid.")
                  : t("TooltipInvalidBlock", "This block is invalid.")
              }
            >
              {data.isValid ? (
                <CheckCircleTwoTone
      ...
      >
          ...
          <Tooltip title={data.currentHash} placement="topLeft">
            ...
            >
              <Tooltip
                title={t(
                  "TooltipHash",
                  "A cryptographic hash uniquely representing this block's content and header."
                )}
            ...
            <Tooltip title={data.previousHash} placement="topLeft">
              ...
              >
                <Tooltip
                  title={t(
                    "TooltipPreviousHash",
                    "The hash of the preceding block, linking this block to the chain."
                  )}
                  placement="bottomLeft"
                >
        ...
        <div style={{ textAlign: "center", marginTop: "auto" }}>
          ...
          {data.coinbase && (
            ...
            >
              {" "}
              {/* AntD gold tag should be theme aware */}
          ...
          >
            {" "}
            {/* AntD blue tag should be theme aware */}
            {p2pTxCount}{" "}
            {t(
              p2pTxCount === 1 ? "P2PTxShortSingular" : "P2PTxShortPlural",
              `${p2pTxCount} P2P Tx(s)`
            )}
          </Tag>
        </div>
